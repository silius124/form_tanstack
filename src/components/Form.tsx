...
function Form({ title, onSubmit, children }: FormProps) {
  return (
    <>
      <form
        className="flex flex-col gap-10 items-center text-white bg-slate-900/60 rounded-xl border border-white/20 shadow-[inset_0_1px_1px_rgba(255,255,255,0.15)] p-6 backdor-blur-md w-auto"
